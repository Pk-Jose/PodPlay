...
class PodcastActivity : AppCompatActivity(), PodcastListAdapter.PodcastListAdapterListener {
    ...
    private fun handleIntent(intent: Intent) { // handle incoming intents
    ...
    override fun onNewIntent(intent: Intent) { // receives updates intent when new search is performed
    ...
    private fun setupViewModels() { // creates instance of ItunesService, uses ViewModelProviders to get instance of
        val service = ItunesService.instance // SearchViewModel
    ...
    private fun hideProgressBar() { // hides progress bar during searching
        databinding.progressBar.visibility = View.INVISIBLE
    }

    private fun createPodcastDetailsFragment(): PodcastDetailsFragment {
        // method either creates the details Fragment or uses an existing instance if one exists
    ...
    private fun showDetailsFragment() { // displays the details Fragment
    ...
    private fun showError(message: String) { // displays a generic alert dialog with an error message
